const queries = {
    ...
    // Querys usadas
    infoUser:"SELECT nombre,apellidos,correo,empresa,tipo FROM core_sariusarios Where idSARIusuarios = @id",
    infoid:"SELECT idSARIusuarios FROM core_sariusarios Where usuario = @username",
    ...
    getTableEtiquetas: "select * from core_sarisitios",   
    ...
    ///
    Series1:'select numSerieLab from core_registro_series where codigoEquipo_id = 3', 
    Series2:"select numeroSerie from Almacen_DetalleSolicitud where FechaApartadoArt between '2022-09-01 00:00:00' and '2022-10-07 23:59:59' and codigoArticulo = 'MR33-HW'" , 
